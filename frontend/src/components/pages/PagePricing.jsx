    ...
    <>
      <nav style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 48px", height: "72px", position: "sticky", top: 0, background: "rgba(255,255,255,0.97)", backdropFilter: "blur(12px)", borderBottom: "1px solid #eef2ee", zIndex: 100 }}>
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          <button onClick={() => setMenuOpen(true)} className="pp-hamburger" aria-label="Open menu"><span /><span /><span /></button>
          <a href="/" style={{ textDecoration: "none" }}><img src="/logo.svg" alt="Dablin" height="44" /></a>
        </div>
        <div className="pp-nav-links" style={{ display: "flex", alignItems: "center", gap: "28px" }}>
          ...
          <a href="/pricing" style={{ fontSize: "15px", fontWeight: "600", color: "#1a7a3a", textDecoration: "none" }}>Pricing</a>
        ...
        <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
          <SignInButton mode="modal"><button className="pp-btn-ghost">Sign in</button></SignInButton>
          <div onClick={() => trackEvent("sign_up_modal_opened", { location: "pricing_nav" })}>
            <SignUpButton mode="modal"><button className="pp-btn-primary">Sign up</button></SignUpButton>
          </div>
        </div>
      </nav>
      {menuOpen && (
        <div style={{ display: "flex", flexDirection: "column", position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "white", zIndex: 500, padding: "24px", overflowY: "auto" }}>
          ...
          <div style={{ marginTop: "24px", display: "flex", flexDirection: "column", gap: "12px" }}>
            <div onClick={() => { trackEvent("sign_up_modal_opened", { location: "mobile_menu" }); setMenuOpen(false); }}>
              <SignUpButton mode="modal"><button className="pp-btn-primary" style={{ width: "100%", padding: "14px", fontSize: "16px", borderRadius: "10px" }}>Sign up free</button></SignUpButton>
            </div>
            <SignInButton mode="modal"><button className="pp-btn-ghost" style={{ width: "100%", padding: "14px", fontSize: "16px", borderRadius: "10px" }} onClick={() => setMenuOpen(false)}>Sign in</button></SignInButton>
          </div>
        </div>
      )}
    </>
    ...
    <div style={{ fontFamily: "'Roboto', sans-serif", color: "#2a3d2b", background: "#ffffff", minHeight: "100vh", overflowX: "hidden" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        .pp-btn-primary { background: #1a7a3a; color: white; border: none; padding: 10px 22px; border-radius: 8px; font-family: 'Roboto', sans-serif; font-size: 14px; font-weight: 600; cursor: pointer; transition: all 0.2s; }
        .pp-btn-primary:hover { background: #2d9a4e; transform: translateY(-1px); }
        .pp-btn-ghost { background: none; border: 1.5px solid #d0e8d4; color: #1a7a3a; padding: 10px 22px; border-radius: 8px; font-family: 'Roboto', sans-serif; font-size: 14px; font-weight: 500; cursor: pointer; transition: all 0.2s; }
        .pp-btn-ghost:hover { border-color: #1a7a3a; background: #eef8f0; }
        .pp-hamburger { display: none; background: none; border: 1px solid #eef2ee; border-radius: 8px; padding: 8px 10px; cursor: pointer; flex-direction: column; gap: 4px; }
        .pp-hamburger span { display: block; width: 18px; height: 2px; background: #2a3d2b; border-radius: 2px; }
        ...
        @media (max-width: 768px) {
          .pp-hero-title { font-size: 44px !important; }
